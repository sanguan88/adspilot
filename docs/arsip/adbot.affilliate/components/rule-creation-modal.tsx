            ...
            <div className="space-y-3">
                  ...
                  {accounts.map((account) => (
                    <SelectItem key={account.id} value={account.id}>
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 rounded-full ${account.status === "active" ? "bg-green-500" : "bg-gray-400"}`}
                        />
                        {account.name}
                      </div>
                    </SelectItem>
              ...
              <div className="grid grid-cols-4 gap-4 p-3 bg-gray-50 rounded-lg">
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-500">Average metrics for the selected ad accounts</div>
                  <div className="text-xs text-gray-500">Last 30 days</div>
                </div>
                <div className="text-center">
                  <div className="text-sm font-medium text-gray-900">N/A</div>
                  <div className="text-xs text-gray-500">Cost per result</div>
                  <div className="text-xs text-gray-500">Purchase ROAS</div>
                </div>
                <div className="text-center">
                  <div className="text-sm font-medium text-gray-900">N/A</div>
          ...
          <Card className="p-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500">Ad set status is active</span>
