            ...
            <Select value={selectedAccount} onValueChange={setSelectedAccount}>
              ...
              <SelectContent>
                ...
                {usernames.map((username) => (
                  <SelectItem key={username.id_toko} value={username.id_toko}>
                    <div className="flex items-center gap-2">
                      <Store className="h-4 w-4 text-muted-foreground" />
            ...
            <div className="flex items-center gap-2">
              <Popover open={startDateOpen} onOpenChange={setStartDateOpen}>
                <PopoverTrigger asChild>
                  <button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md border border-input bg-background px-3 py-2 text-sm font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 w-full sm:w-[200px] justify-start text-left font-normal cursor-pointer"
                  >
                    <Calendar className="mr-2 h-4 w-4 shrink-0" />
                    {startDate ? startDate.toLocaleDateString('id-ID', { day: '2-digit', month: 'short', year: 'numeric' }) : <span>Dari</span>}
                  </button>
                </PopoverTrigger>
              ...
              <Popover open={endDateOpen} onOpenChange={setEndDateOpen}>
                <PopoverTrigger asChild>
                  ...
                  >
                    <Calendar className="mr-2 h-4 w-4 shrink-0" />
                    {endDate ? endDate.toLocaleDateString('id-ID', { day: '2-digit', month: 'short', year: 'numeric' }) : <span>Sampai</span>}
                  </button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start" side="bottom">
                  <CalendarComponent
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white border rounded-sm p-6 w-full shadow-sm relative transition-all duration-200 hover:shadow-md hover:-translate-y-1 cursor-pointer">
            ...
            <div className="flex flex-col items-start gap-2">
              ...
              <p className="text-3xl font-bold text-gray-900">
                {(totalMetrics.clicks || 0).toLocaleString()}
              </p>
          ...
          <div className="bg-white border rounded-sm p-6 w-full shadow-sm relative transition-all duration-200 hover:shadow-md hover:-translate-y-1 cursor-pointer">
            ...
            <div className="flex flex-col items-start gap-2">
              ...
              <p className="text-3xl font-bold text-gray-900">{(totalMetrics.conversions || 0).toLocaleString()}</p>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="p-6 bg-white border rounded-sm shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-1 cursor-pointer">
                  <div className="flex flex-col items-start gap-2">
                    ...
                    <p className="text-3xl font-bold text-gray-900">{totalMetrics.rules || 0}</p>
                  </div>
                </div>
              </div>
            </CardContent>
                ...
                accounts.map((account, index) => (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:flex lg:items-center lg:space-x-4 gap-2 text-xs">
                      ...
                      <div className="text-center sm:text-right">
                        <p className="font-medium text-gray-900">Rp{(account.gmv || 0).toLocaleString()}</p>
