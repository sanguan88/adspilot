...
const CATEGORY_INFO = {
  stars: {
    icon: Star,
    label: 'Stars',
    description: 'Iklan dengan pertumbuhan tinggi dan performa di atas rata-rata',
  ...
  cash_cows: {
    icon: DollarSign,
    label: 'Cash Cows',
    description: 'Iklan stabil dengan performa bagus, pertumbuhan melambat',
  ...
  question_marks: {
    ...
    description: 'Iklan tumbuh cepat tapi performa masih di bawah rata-rata',
    action: 'Evaluasi dan optimasi, atau pertimbangkan stop',
    color: COLORS.question_marks,
  },
  dogs: {
    icon: AlertTriangle,
    label: 'Dogs',
    description: 'Iklan dengan performa rendah dan pertumbuhan lambat',
    action: 'Pertimbangkan pause/stop atau optimasi besar',
    color: COLORS.dogs,
  },
}

export function RekamMedicInterpretation({ categoryCounts, totalCampaigns, bcgData = [], dateRange }: InterpretationProps) {
        ...
        <CollapsibleTrigger asChild>
          <button className="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
            <div className="flex items-center gap-3">
              <div className="text-lg font-semibold text-gray-900">III. INTERPRETASI HASIL</div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-900 mb-3 uppercase tracking-wide">
                    Cara Membaca BCG Matrix
                  </h4>
                  <div className="text-sm text-gray-700 space-y-2">
                    <p>
                      <strong>X-Axis (Market Share):</strong> Menunjukkan kinerja relatif iklan dibandingkan rata-rata. 
                      Semakin ke kanan, semakin baik performanya.
                    </p>
                    <p>
                      <strong>Y-Axis (Growth Rate):</strong> Menunjukkan tingkat pertumbuhan revenue iklan. 
                    ...
                    <table className="w-full text-sm border-collapse">
                      <thead>
                        <tr className="border-b-2 border-gray-300">
                          <th className="text-left p-3 font-semibold text-gray-900">Kategori</th>
                          <th className="text-center p-3 font-semibold text-gray-900">Jumlah</th>
                          <th className="text-center p-3 font-semibold text-gray-900">Persentase</th>
                          <th className="text-center p-3 font-semibold text-gray-900">Status</th>
                          <th className="text-left p-3 font-semibold text-gray-900">Tindakan</th>
                          <th className="text-center p-3 font-semibold text-gray-900">Aksi</th>
                        </tr>
                      </thead>
                      <tbody>
                        {categories.map((cat, index) => (
                          ...
                          >
                            ...
                            <td className="p-3 text-center font-semibold">{cat.count}</td>
                ...
                {selectedCategory && (
                  <RekamMedicCategoryModal
                    ...
                    campaigns={bcgData}
                    categoryLabel={CATEGORY_INFO[selectedCategory]?.label || ''}
                    categoryColor={CATEGORY_INFO[selectedCategory]?.color || '#000'}
                  />
                )}
