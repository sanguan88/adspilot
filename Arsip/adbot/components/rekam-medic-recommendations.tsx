...
export function RekamMedicRecommendations({
  ...
  if (starsCount > 0) {
    recommendations.push({
      priority: 1,
      icon: Star,
      title: `PRIORITAS TINGGI: Stars (${starsCount} iklan)`,
      description: `${starsCount} iklan Anda menunjukkan pertumbuhan tinggi dengan performa di atas rata-rata.`,
      actions: [
        'Pertahankan budget dan tingkatkan investasi pada iklan Stars',
        'Monitor performa secara berkala untuk memastikan konsistensi',
        'Scale up iklan Stars yang menunjukkan ROI terbaik',
        'Gunakan data Stars sebagai benchmark untuk optimasi iklan lain',
      ],
      color: '#059669',
    })
  }
  ...
  if (dogsCount > 0) {
    ...
    recommendations.push({
      priority: 2,
      icon: AlertTriangle,
      title: `PERHATIAN: Dogs (${dogsCount} iklan - ${dogsPercentage.toFixed(1)}%)`,
      description: `${dogsCount} iklan (${dogsPercentage.toFixed(1)}%) masuk kategori Dogs yang memerlukan evaluasi segera.`,
      actions: [
        'Evaluasi satu per satu iklan Dogs untuk menentukan penyebab performa rendah',
        'Pertimbangkan pause atau stop iklan yang jelas tidak efektif',
        'Lakukan optimasi besar (kreatif, targeting, budget) sebelum stop',
        'Alihkan budget dari Dogs ke Stars untuk efisiensi',
      ],
      color: '#DC2626',
    })
  }

  // Priority 3: Question Marks
  if (questionMarksCount > 0) {
    recommendations.push({
      priority: 3,
      icon: HelpCircle,
      title: `MONITORING: Question Marks (${questionMarksCount} iklan)`,
      description: `${questionMarksCount} iklan menunjukkan potensi tapi perlu optimasi lebih lanjut.`,
      actions: [
        ...
        'Pelajari dari Stars untuk strategi optimasi',
      ],
      color: '#D97706',
    })
  }

  // Priority 4: Cash Cows
  if (cashCowsCount > 0) {
    recommendations.push({
      priority: 4,
      icon: TrendingUp,
      title: `STABIL: Cash Cows (${cashCowsCount} iklan)`,
      description: `${cashCowsCount} iklan stabil dengan performa bagus.`,
      actions: [
        'Pertahankan budget dan optimasi untuk efisiensi',
        'Monitor untuk memastikan tidak turun ke kategori Dogs',
        'Gunakan sebagai sumber pendapatan stabil',
      ],
      color: '#2563EB',
    })
  }
        ...
        <CollapsibleTrigger asChild>
          <button className="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
            <div className="flex items-center gap-3">
              <div className="text-lg font-semibold text-gray-900">IV. REKOMENDASI</div>
              ...
              <div className="space-y-6">
                ...
                {insights.length > 0 && (
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    <h4 className="text-sm font-semibold text-gray-900 mb-3">Insight Tambahan</h4>
