            ...
            <Card>
              ...
              <CardContent>
                <ol className="space-y-3 list-decimal list-inside">
                  ...
                  <li className="text-sm">
                    Setelah transfer, kirim bukti pembayaran ke email:{" "}
                    <a 
                      href={`mailto:${paymentSettings?.confirmationEmail || 'support@shopadexpert.com'}`}
                      className="text-primary hover:underline font-medium"
                    >
                      {paymentSettings?.confirmationEmail || 'support@shopadexpert.com'}
                    </a>
                  </li>
                  <li className="text-sm">
                    Atau hubungi admin via Telegram untuk konfirmasi pembayaran
                  </li>
                  <li className="text-sm">
                    Akun Anda akan diaktifkan dalam <strong>1x24 jam</strong> setelah pembayaran dikonfirmasi
                  </li>
                </ol>
              </CardContent>
            </Card>
