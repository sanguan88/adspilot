          ...
          <div className="space-y-4 text-center lg:text-left">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-500 text-sm">
                Belum punya akun?{' '}
                <Link href={`${process.env.NEXT_PUBLIC_LANDING_PAGE_URL || 'https://adspilot.id'}/#harga`} className="text-teal-600 hover:text-teal-700 font-semibold transition-colors underline">
