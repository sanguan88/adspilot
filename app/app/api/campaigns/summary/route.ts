...
`
    ...
    try {
      ...
      console.error(`[summary] Failed to cleanup temp file ${tempScriptPath}:`, cleanupError)
    }
  }
}
...
async function getAccountsWithCookies(connection: PoolClient, user: any, tokoIds: string[]) {
  try {
    ...
    // Add user_id as FIRST param if needed
    let userFilter = ''
    ...
    // Add tokoIds placeholders AFTER user_id
