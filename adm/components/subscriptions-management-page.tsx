...
import { CreditCard, Plus, Search, FileText, DollarSign, Edit, Trash2, Settings, Check, ChevronsUpDown } from "lucide-react"
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="border-t pt-4">
                <Label className="text-base font-semibold mb-3">Features & Limits</Label>
                <div className="space-y-4">
                  {/* Max Accounts */}
                  <div>
