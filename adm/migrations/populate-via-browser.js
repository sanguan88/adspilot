// Full landing page content - can be imported via API
// Run this in the browser console while on localhost:3001/page-builder
            ...
            blocks: [
                {
                    ...
                    components: {
                        ...
                        answer: 'Ya, 100% aman. Kami menggunakan enkripsi SSL 256-bit dan tidak pernah menyimpan password Anda. Kami hanya menggunakan session cookies yang ter enkripsi untuk mengakses akun Shopee Anda.'
                    }
                },
                {
                    id: 'faq-2',
...
fetch('/api/page-builder?page=landing', {
    method: 'PUT',
